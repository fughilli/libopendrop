...
def main(argv):
    ...
    guard_symbol = wrap_lib.MakeGuardSymbol(shader_filename)
    namespace = wrap_lib.MakeNamespace(shader_filename)
    hash_string = wrap_lib.MakeHashString(shader_filename, code_text)
