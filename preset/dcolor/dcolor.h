#ifndef PRESETS_DCOLOR_DCOLOR_H_
#define PRESETS_DCOLOR_DCOLOR_H_
...
class Dcolor : public Preset {
 public:
  static absl::StatusOr<std::shared_ptr<Preset>> MakeShared(
      std::shared_ptr<gl::GlTextureManager> texture_manager);

  std::string name() const override { return "Dcolor"; }

  int max_count() const override { return 1; }

 protected:
  Dcolor(std::shared_ptr<gl::GlProgram> warp_program,
...
#endif  // PRESETS_DCOLOR_DCOLOR_H_
