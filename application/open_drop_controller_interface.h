#ifndef APPLICATION_OPEN_DROP_CONTROLLER_INTERFACE_H_
#define APPLICATION_OPEN_DROP_CONTROLLER_INTERFACE_H_
...
#endif  // APPLICATION_OPEN_DROP_CONTROLLER_INTERFACE_H_
